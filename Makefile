...
#*   Updated: 2017/10/24 13:55:18 by psebasti         ###   ########.fr       *#
#*                                                                            *#
#* ************************************************************************** *#
...
debug : FLAGS += -g3 -fsanitize=address 
debug : DEBUG_LFT=true
debug : debug_lft all
...
$(NAME): $(OBJ)
	@echo
ifeq ($(DEBUG_LFT), true)
	@echo "DEBUG_LFT defined"
else
	@echo "DEBUG_LFT undefined"
endif
	@make -C $(LFTDIR)
...
# if $(filter-out gcc,$(CMP)),$(info is not gcc)$(info is gcc))$(NAME): $(OBJ)
